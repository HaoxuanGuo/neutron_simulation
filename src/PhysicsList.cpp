...
// TODO: WHICH MODEL WE SHOULD USE?
...
PhysicsList::PhysicsList() : G4VModularPhysicsList() {
	...
	RadioactiveDecayPhysicsList = new G4RadioactiveDecayPhysics();
}
...
void PhysicsList::SetCuts() {G4VUserPhysicsList::SetCuts();}
